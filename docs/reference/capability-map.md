...
manage_domains | Manage the domains this instance serves, and portable site packages. | api: domains-list, domain-add, domain-set, domain-remove, domain-alias-add, domain-preview, domain-check, site-backup-create, site-backup-upload, site-backup-apply; mcp: site_backup, site_apply
