...
brand: plain
status: candidate
status-note: "PROPOSED 2026-07-24, scoped from the theme-authoring / Figma design-transfer briefing (item 5). Audited: trivial code (manifest field + one passthrough loop); the backfill is a reviewed writing pass. Independent - can land any time."
---
