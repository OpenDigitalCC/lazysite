...
brand: plain
status: candidate
status-note: "field reports 2026-07-22. Three parts: (1) BUG - connected-detection regression; (2) copy - genericness; (3) capability-aware tools/list for an authenticated session. For the next batch."
---
