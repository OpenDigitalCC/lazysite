...
brand: plain
status: candidate
status-note: "Captured 2026-07-18 from the providers.explore.lazysite.io build-out (site agent claude-code). No code yet. Builds directly on SM110/SM151; P4 (content-root-relative json:/include resolution) also fixes a live multi-site wart found during the sites/providers migration."
---
