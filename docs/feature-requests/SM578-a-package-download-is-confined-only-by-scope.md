...
It is a behaviour change for existing partners, so it is the operator's
call: a broadly-granted partner that today reaches every domain would
stop doing so.
