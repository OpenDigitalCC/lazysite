...
<!-- lazysite:field-practice-import
     ...
     body-sha256: 117b1ba0ad1177516effee3ca03051dbdd432fec43859840b07a8dfe929744e1
-->
...
This copy was **generated for engine 0.11.10**. The last section, *Where this came from*, names the sources, the agent and the dates.
...
Imported on **2026-09-01** by `tools/import-field-practice.pl`, for the engine version stamped at the top of this page. Written by **the lazysite site agent (Claude Code)** - the agent that builds and maintains sites on this engine - as a working record, and kept current in its own project trees:
