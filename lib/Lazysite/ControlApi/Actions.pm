...
our %ACTION = (
    'acl-get' => { caps => ['manage_content'], params => [ { name => 'path', in => 'query' } ] },
    ...
    'artifact-backups-delete' => { caps => ['purge'], params => [ { name => 'path', in => 'query' } ] },
    ...
    'data-table-drop' => { caps => ['housekeeping'], params => [ { name => 'table', in => 'query_or_body' }, { name => 'confirm', in => 'body' } ] },
    'data-tables'         => { caps => ['manage_data'], params => [] },
    'data-safety-exports' => { caps => ['manage_data'], params => [] },
    'data-safety-export-delete' => { caps => ['purge'], params => [ { name => 'file', in => 'query_or_body' } ] },
