#=========================================================================#
# lazysite-cgi Web Domain Template (plain-CGI pattern)                    #
...
# Markdown pages route through the CGI auth wrapper (FallbackResource).   #
# Needs: a2enmod headers rewrite (+ include for SSI overlays).            #
# https://lazysite.io                                                     #
